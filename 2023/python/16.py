...
def do_path(lines, init_coords, direction):
    energized = 0
    coords = init_coords
    ...
    elif (lines[coords(0)][coords(1)] == "-" and direction in [(1, 0), (-1, 0)]) or (
        lines[coords(0)][coords(1)] == "|" and direction in [(0, 1), (0, -1)]
    ):
        energized = do_path(lines, 0, 0) + do_path(lines, 0, 0)
